 ...
 **********************************************************************************************************
 * 实验简介
 * 实验名称：ATK-MD0240模块测试实验
 * 实验平台：正点原子 MiniSTM32 V4开发板
 * 实验目的：学习ATK-MD0240的使用方法

 **********************************************************************************************************
 * 硬件资源及引脚分配
 * 1 串口1 (PA9/PA10连接在板载USB转串口芯片CH340上面)
 * 2 ALIENTEK 2.8/3.5/4.3/7/10寸TFTLCD模块(仅限MCU屏，16位8080并口驱动)
 * 3 ATK-MD0240模块

 **********************************************************************************************************
 * 实验现象
 * 1 程序烧录后，自动完成ATK-MD0240模块及其相关硬件的初始化。
 * 2 ATK-MD0240模块初始化完成后，在ATK-MD0240模块LCD显示屏上显示实验信息，以及立方体3D旋转演示。
