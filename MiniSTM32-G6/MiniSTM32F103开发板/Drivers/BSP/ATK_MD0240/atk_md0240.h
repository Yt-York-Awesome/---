...
/* 引脚定义 */
#define ATK_MD0240_PWR_GPIO_PORT            GPIOC
#define ATK_MD0240_PWR_GPIO_PIN             GPIO_PIN_11
#define ATK_MD0240_PWR_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)
#define ATK_MD0240_CS_GPIO_PORT             GPIOD
#define ATK_MD0240_CS_GPIO_PIN              GPIO_PIN_2
#define ATK_MD0240_CS_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)
#define ATK_MD0240_WR_GPIO_PORT             GPIOB
#define ATK_MD0240_WR_GPIO_PIN              GPIO_PIN_6
#define ATK_MD0240_WR_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)
#define ATK_MD0240_RST_GPIO_PORT            GPIOB
#define ATK_MD0240_RST_GPIO_PIN             GPIO_PIN_8
#define ATK_MD0240_RST_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)
...
void atk_md0240_ShowChinese(uint16_t x,uint16_t y,uint8_t *s,uint16_t fc,uint16_t bc,uint8_t sizey,uint8_t mode);//显示汉字串
void atk_md0240_Chinese12x12(uint16_t x,uint16_t y,uint8_t *s,uint16_t fc,uint16_t bc,uint8_t sizey,uint8_t mode);//显示单个12x12汉字
void atk_md0240_Chinese16x16(uint16_t x,uint16_t y,uint8_t *s,uint16_t fc,uint16_t bc,uint8_t sizey,uint8_t mode);//显示单个16x16汉字
void atk_md0240_Chinese24x24(uint16_t x,uint16_t y,uint8_t *s,uint16_t fc,uint16_t bc,uint8_t sizey,uint8_t mode);//显示单个24x24汉字
void atk_md0240_Chinese32x32(uint16_t x,uint16_t y,uint8_t *s,uint16_t fc,uint16_t bc,uint8_t sizey,uint8_t mode);//显示单个32x32汉字
